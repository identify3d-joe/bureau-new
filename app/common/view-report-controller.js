...
define([], function () {
  ...
  function ViewReportController($q, $scope, $rootScope, $stateParams, $state, $modal, $aside, $modalInstance, Identify3D, deviceData, reportData, confirmationDialogService){
  ...
  return {'ViewReportController': ['$q','$scope', '$rootScope', '$stateParams', '$state', '$modal', '$aside', '$modalInstance', 'Identify3DObject', 'deviceData', 'reportData', 'confirmationDialogService', ViewReportController]};
});
